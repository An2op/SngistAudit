...
public class RecyclerViewAdapterClass extends RecyclerView.Adapter<RecyclerViewAdapterClass.MyViewHolder> {
    ...
    private List<ClassData> albumList;
private String type;
...
public Button delete;
    ...
    public RecyclerViewAdapterClass(Context mContext, List<ClassData> albumList,String type) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
       final ClassData product = albumList.get(position);
        holder.stationid.setText(product.getSubject_id());
        holder.stationtype.setText("Semester:"+product.getSemester());
        holder.address.setText("Details:"+product.getClass_details());
        if(Utility.USERTYPE.equals("STUDENT")){
            holder.phone.setText("Date:"+product.getDate());
        holder.pincode.setText("Teacher:"+product.getStaff_id());}
        else
        {
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                deletearrang(product.getBatch_id());
            }
        });
...
//    }
    ...
    private void deletearrang(final String noidd) {
        ...
        //{"batchid":"","option":"remedial"}

        params.put("batchid", noidd);
        params.put("option", type);


        Call<JsonObject> jsonObjectCall = new Retrofit_Helper().getRetrofitBuilder().getfromServer(Utility.remodyremoveurl,params);
...
//}if(
                                ...
                                Utility.classActivity.getNotification();
                                else
                                    Utility.classActivityr.getNotification();
