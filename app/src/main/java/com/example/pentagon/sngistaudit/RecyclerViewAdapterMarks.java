 ...
 */
public class RecyclerViewAdapterMarks extends RecyclerView.Adapter<RecyclerViewAdapterMarks.MyViewHolder> {
...
public Button delete;
    ...
    public RecyclerViewAdapterMarks(Context mContext, List<MarksData> albumList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
       ...
       if(!Utility.USERTYPE.equals("STUDENT"))
        holder.stationid.setText("Student:"+product.getStudent_id());
           ...
           holder.stationid.setText("Semester:"+product.getSemester());

        holder.stationtype.setText("Semester:"+product.getSemester());
        holder.address.setText("Subject:"+product.getSubject_id());
        holder.pincode.setText("Internal_type:"+product.getInternal_type());
        holder.phone.setText("Mark:"+product.getMark());
        if(Utility.USERTYPE.equals("FACULTY"))
        holder.delete.setVisibility(View.VISIBLE);
        holder.delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                deletearrang(product.getMark_id());
            }
        });
