...
public class TClassViewActivity extends AppCompatActivity {
...
addAttendence();
    ...
    public void getNotification() {
        ...
        Call<JsonObject> jsonObjectCall = new Retrofit_Helper().getRetrofitBuilder().getfromServer(Utility.tutorialsurl,params);
        jsonObjectCall.clone().enqueue(new ResponseHandler(TClassViewActivity.this, new ResponseCallback() {
            @Override
...
//            "district_id":"3","address":"Kattappana","phone":"04898745854","station_type":"2","password":""},
            ...
            public void getFailure(Call<JsonObject> call, int code) {
                if (code==1) {
                    ...
                    Toast.makeText(TClassViewActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();

                } else {
                    Toast.makeText(TClassViewActivity.this, "Can't Connect with server", Toast.LENGTH_SHORT).show();
    ...
    private void setView() {
        ...
        adapter1 = new RecyclerViewAdapterClass(TClassViewActivity.this,station,"tutorial");
        recyclerView.setVisibility(View.VISIBLE);

        recyclerView.setHasFixedSize(true);
        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(TClassViewActivity.this, 1,GridLayoutManager.VERTICAL,false);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(TClassViewActivity.this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
...
//                    popup.show();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i=new Intent(TClassViewActivity.this,HomeActivity.class);
        startActivity(i);
        finish();
    }
...
//            "district_id":"3","address":"Kattappana","phone":"04898745854","station_type":"2","password":""},
                    ...
                    spstudent.setAdapter(
                            new ArrayAdapter<SubjectData>(TClassViewActivity.this,R.layout.support_simple_spinner_dropdown_item,station));
    ...
    public void addAttendence() {
        final Dialog dd=new Dialog(TClassViewActivity.this);
        ...
        ((TextView)dd.findViewById(R.id.head)).setText("Tutorial Class");
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int month = c.get(Calendar.MONTH);
                int day = c.get(Calendar.DAY_OF_MONTH);
                DatePickerDialog dd = new DatePickerDialog(TClassViewActivity.this, new DatePickerDialog.OnDateSetListener() {
...
//        newFragment.show(getFragmentManager(),"timePicker");
        ...
        ((Button)dd.findViewById(R.id.add)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(TClassViewActivity.this, "All Fields are Required", Toast.LENGTH_SHORT).show();
...
//            "district_id":"3","address":"Kattappana","phone":"04898745854","station_type":"2","password":""},
    ...
    private void newatt(String stid, String subid, String sem, String date, String details, String type) {
      ...
      //  params.put("type", type);
        ...
        Call<JsonObject> jsonObjectCall = new Retrofit_Helper().getRetrofitBuilder().getfromServer(Utility.addtutorialurl,params);
        jsonObjectCall.clone().enqueue(new ResponseHandler(TClassViewActivity.this, new ResponseCallback() {
            @Override
            public void getResponse(int code, JsonObject jsonObject) {
                    ...
                    try {
                        if (jsonObj.has("class")) {
                            if(jsonObj.getString("class").equals("true")){
                                Toast.makeText(TClassViewActivity.this, "Added", Toast.LENGTH_SHORT).show();
...
//setView();
                                ...
                                Toast.makeText(TClassViewActivity.this, "Failed", Toast.LENGTH_SHORT).show();
